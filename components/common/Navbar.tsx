  ...
  return (
    <div>
      ...
      <div className="lg:hidden w-screen fixed bottom-0 bg-light-green border-t border-grey-1 h-[71px] grid grid-cols-3">
        <Link href={"/my-contest"} className="text-xl flex justify-center items-center">
          <Image
        ...
        <Link href={"/profile"} className="text-xl flex justify-center items-center">
          <Image
        ...
        <Link href={"/logout"} className="text-xl justify-center items-center flex">
          <Image
